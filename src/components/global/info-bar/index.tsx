	...
	return (
		<header className="pl-20 md:pl-[265px] fixed p-4 w-full flex items-center justify-between gap-4">
			<div className="flex gap-4 justify-center items-center border-2 rounded-full px-4 w-full max-w-lg">
				...
				<Input
					className="bg-transparent border-none !placeholder-neutral-500 selection:border-none focus:border-none"
					placeholder="Search for people, projects, tags & folders"
				/>
			</div>
			<div className="flex items-center gap-4">
				<Button className="bg-[#1D1D1D] text-[#9D9D9D] hover:bg-[#242323] flex items-center gap-2">
					<UploadIcon size={20} />{' '}
					<span className="flex items-center gap-2">Upload</span>
				</Button>
				<Button className="bg-[#EAEAEA] hover:bg-[#EAEAEA] text-black flex items-center gap-2">
					<VideoRecorderIcon />
